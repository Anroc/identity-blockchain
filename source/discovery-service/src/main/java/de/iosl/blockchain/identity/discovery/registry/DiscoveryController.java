...
public class DiscoveryController {
	...
	@GetMapping()
	public List<RegistryEntryDTO> getEntries(@RequestParam(value = "domainName", defaultValue = "") final String domainName) {
	...
	@PostMapping()
	public ResponseEntity<URL> createEntry(@Valid @RequestBody RegistryEntryDTO registryEntry, HttpServletRequest request) {
