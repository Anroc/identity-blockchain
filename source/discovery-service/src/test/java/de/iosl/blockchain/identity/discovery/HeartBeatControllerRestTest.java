...
public class HeartBeatControllerRestTest extends RestTestSuite {
    ...
    private static final EventType eventType = EventType.NEW_CLAIMS;
    private static final SubjectType subjectType = SubjectType.URL;

    private RequestDTO<HeartBeatRequest> requestDTO;

    @Before
    public void setup() {
        HeartBeatRequest payload = new HeartBeatRequest(ETH_ID, ENDPOINT, eventType, subjectType);
