...
import de.iosl.blockchain.identity.core.register.keychain.data.EncryptedKeyChain;
import de.iosl.blockchain.identity.core.register.keychain.data.EncryptedKeySpec;
...
public class KeyChainService {
	...
	public static final String WALLET_DIR = System.getProperty("user.home") + File.separator
