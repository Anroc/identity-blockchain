...
public class StringSymmetricCryptEngineTest {
    ...
    private void encryptDecrypt(SymmetricCryptEngine<String> engine,
            String message) throws Exception {
        String encryptedBase64 = engine
                .encrypt(message, engine.getSymmetricCipherKey());
        ...
        String decrypt = engine
                .decrypt(encryptedBase64, engine.getSymmetricCipherKey());
